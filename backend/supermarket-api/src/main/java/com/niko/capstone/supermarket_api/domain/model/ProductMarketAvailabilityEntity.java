// File purpose: Maps the product market availability entity database record to a JPA entity.
...
@Entity
@Table(name = "product_market_availability")
@Getter
@Setter
@NoArgsConstructor
public class ProductMarketAvailabilityEntity {
